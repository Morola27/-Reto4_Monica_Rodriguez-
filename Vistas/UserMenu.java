   ...
   DefaultTableModel contenidoTablaEmpleados,contenidoTablaDepartamentos;
    ...
    try{
        ...
        while (rs.next()){
            ...
            System.out.println("Sucural" + departamentos [0]+ "Departamento"+ departamentos [1]);
    ...
    private void initComponents() {
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/newUser.png"))); // NOI18N
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        String departamentoOpntion = cbnombreDepartamento.getSelectedItem().toString();
        ...
        System.out.println(" departamento: " + departamentoOpntion + ", zona: " + zonaOption + ", Tipo calle "
                + tipoCalleOption + ", número:  " + numero1 + " - " + numero2 + " - " + numero3);
          
        String queryDireccion ="INSERT INTO `direccion`( `zona`, `tipoCalle`, `numero1`, `numero2`, `numero3`, `nombreDepartamento`) VALUES ('"+zonaOption+"','"+tipoCalleOption+"','"+numero1+"','"+numero2+"','"+numero3+"','"+departamentoOpntion+"')"; 
        ...
        try {
            ...
            String queryIdDireccion = " SELECT idDireccion `direccion` WHERE nombreDepartamento = '" + departamentoOpntion + "' AND zona = '" + zonaOption + "' AND tipoCalle= '" + tipoCalleOption + "' AND numero1= '" + numero1 + "' AND numero2= '" + numero2 + "' AND numero3= '" + numero3 + "';";
            ...
            try {
                ...
                while (rs.next()){
                  ...
                  System.out.println(" Enviar " +idDireccion);
                }
